...
dst = "/home/shuubham/Desktop/spine1_train/whisper_train/noisy_files/path_to_clips/validation/"+snr+"/"+noise_type
...
with open("validation_arl.csv", "a") as validation_arl:
    writer = csv.writer(validation_arl)
